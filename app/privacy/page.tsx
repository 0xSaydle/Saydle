  ...
  return (
    <LegalPage title="Privacy Policy" updated="7 September 2026">
      <Text pt={"16px"} textStyle={"body_lg"} color={"dark.300"} lineHeight={1.7}>
        ...
        why we collect it, and what happens to it. The short version: we
        collect what the product needs to work, we sell nothing, and we show
        you no ads.
      </Text>
      ...
      <LegalSection title="What we collect">
        ...
        <Text pt={"12px"}>
          ...
          profile answers: how you have been feeling, what you want to focus
          on, the tone that suits you. Sharing these is optional. They exist so
          your affirmations can be written for you rather than for everyone.
        </Text>
        <Text pt={"12px"}>
          <b>What you do in the app.</b> Affirmations you favourite or save,
          lines you write yourself, your reading streak, and preferences such
          as theme, language, reminder times, and reading voice.
        </Text>
        <Text pt={"12px"}>
      ...
      <LegalSection title="Who processes it">
        <Text pt={"8px"}>
          ...
          receives only what its job requires: secure database hosting, the
          service that writes affirmations from your preferences, the service
          that turns affirmation text into audio (it receives the text only,
          never your name or account details), the service that processes
          subscription events from Apple and Google, and the service that
      ...
      <LegalSection title="Reminders">
        <Text pt={"8px"}>
          ...
          push notification service and cannot send anything to your phone
          from our servers.
        </Text>
      </LegalSection>
      ...
      <LegalSection title="Deleting your account">
        <Text pt={"8px"}>
          ...
          permanently removed except one minimal record: a scrambled,
          unreadable form of your email and your billing history, kept for six
      ...
      <LegalSection title="Your rights">
        <Text pt={"8px"}>
          ...
          you can manage directly in the app, and all of it by writing to us.
          If you are in the EU or the UK these are your GDPR rights; we honour
